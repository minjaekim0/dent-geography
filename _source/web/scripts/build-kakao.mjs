...
page = replaceOnce(page, '</style><body>', '</style><link rel="stylesheet" href="kakao.css?v=daytime-history-1"><body>');
const mapToolbar = `
...
page = replaceOnce(page, '<footer id="foot">', `<p class="map-source-note">배경지도·지명·도로·장소/주소 검색: Kakao. 통계 색상은 기존 분석 지도와 동일한 값입니다. 행정구역 경계와 지하철 노선 강조선은 기존 원자료를 카카오 지도에 표시합니다. 카카오 배경의 최신 지명·경계와 분석 기준 시점이 다를 수 있습니다. <a href="https://apis.map.kakao.com/web/documentation/" target="_blank" rel="noopener">지도 API 안내</a></p><footer id="foot">`);
page += '\n<script src="kakao-map.js"></script>\n<script src="kakao-population-panel.js"></script>\n<script src="kakao-core.js"></script>\n</body></html>\n';
